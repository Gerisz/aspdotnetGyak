...
namespace ELTE.TodoList.Web.Models
{
    public static class DbInitializer
    {
        public static void Initialize(TodoListDbContext context, string imageDirectory)
        {
            ...
            string applePath = Path.Combine(imageDirectory, "apple.png");
            string pearPath = Path.Combine(imageDirectory, "pear.png");
            string beerPath = Path.Combine(imageDirectory, "beer.png");
